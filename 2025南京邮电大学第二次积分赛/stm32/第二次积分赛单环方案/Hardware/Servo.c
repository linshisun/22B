...
void Servo_Init(void)
{
	...
	TIM_OC1Init(TIM4, &TIM_OCInitStructure);                        //将结构体变量交给TIM_OC1Init，配置TIM4的输出比较通道2
...
/**
  ...
  * 返 回 值：无
  */
void Servo_SetAngle(float Angle_Servo)
{
	TIM_SetCompare1(TIM4, Angle_Servo / 180*2000+500);		//设置CCR1的值
}
